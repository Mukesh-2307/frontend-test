...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center text-white xl:pt-10 md:pt-6 pt-2 xl:px-10 md:px-6 px-4 relative'>
            <div className='flex gap-2 justify-evenly items-center'>
                <TbPlant2 className='size-[20px] md:size-[30px] xl:size-[40px]' />
                <h1 className='font-bold'>FloraVision.</h1>
            </div>

            <div className='hidden md:block'>
                <ul className='flex md:gap-5 xl:gap-20 font-medium'>
                    <li>
                        <a href="#">Home</a>
                    </li>
                    <li>
            ...
            <div className='flex md:gap-10 gap-4'>
                <IoSearchSharp className='cursor-pointer md:size-[30px] xl:size-[40px]' />
                <IoBagHandleOutline className='cursor-pointer md:size-[30px] xl:size-[40px]' />
